    ...
    <section className="scroll-mt-24" id="services">
      ...
      <div className="grid gap-10 md:grid-cols-2 xl:grid-cols-3">
        {services.map((service) => (
          <article className="group grid min-h-[322px] justify-items-center gap-6 rounded-3xl bg-white/[0.04] px-8 py-9 text-center transition duration-300 hover:-translate-y-2 hover:bg-white/[0.07] hover:shadow-2xl hover:shadow-black/20 motion-safe:animate-fade-up" key={service.title}>
